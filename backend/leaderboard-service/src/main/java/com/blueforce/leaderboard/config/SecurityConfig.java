package com.blueforce.leaderboard.config;
...
public class SecurityConfig {
    ...
    @Bean
    public org.springframework.core.convert.converter.Converter<Jwt, org.springframework.security.authentication.AbstractAuthenticationToken> jwtAuthConverter() {
